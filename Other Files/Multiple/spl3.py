...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.instructionBrowser.setGeometry(QtCore.QRect(0, 0, 1011, 551))
        ...
        self.articleBrowser.setGeometry(QtCore.QRect(0, 10, 1011, 491))
        ...
        self.tab1Highlight.setGeometry(QtCore.QRect(490, 520, 111, 23))
        self.tab1Highlight.setObjectName("tab1Highlight")
        self.tab2Highlight = QtWidgets.QRadioButton(self.articleTab)
        self.tab2Highlight.setGeometry(QtCore.QRect(600, 520, 111, 23))
        ...
        self.restoreMainArticle.setGeometry(QtCore.QRect(720, 520, 111, 23))
        self.restoreMainArticle.setObjectName("restoreMainArticle")
        self.multiple_summary = QtWidgets.QPushButton(self.articleTab)
        self.multiple_summary.setGeometry(QtCore.QRect(870, 510, 141, 41))
        ...
        self.tab1Download.setGeometry(QtCore.QRect(870, 510, 141, 41))
        self.tab1Download.setObjectName("tab1Download")
        self.pageBrowser = QtWidgets.QTextBrowser(self.pageTab)
        self.pageBrowser.setGeometry(QtCore.QRect(0, 10, 1011, 491))
        ...
        self.tab2Download.setGeometry(QtCore.QRect(870, 510, 141, 41))
        self.tab2Download.setObjectName("tab2Download")
        self.nonpageBrowser = QtWidgets.QTextBrowser(self.nopageTab)
        self.nonpageBrowser.setGeometry(QtCore.QRect(0, 10, 1011, 491))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.restoreMainArticle.setText(_translate("Dialog", "প্রবন্ধ পুনঃস্থাপন"))
        ...
        self.Tabs.setTabText(self.Tabs.indexOf(self.nopageTab), _translate("Dialog", "সারমর্ম ২ (নিয়মিত পদ্ধতি)"))
