...
#from ntest import common_words,chars_to_delete,calculate_degree,calculate_sentence_freq,similar_words
...
#for i in range(len(texts)):
    #features.append([len(texts[i]),1/sqrt(i+1),common_words(tittle,texts[i]),calculate_degree(texts[i],texts,i),calculate_sentence_freq(texts[i],vocab)])
    # print(len(texts[i]))
    # print(calculate_degree(texts[]))

for i in range(len(texts)):
    features.append([len(texts[i]),common_words(tittle,texts[i]),calculate_degree(texts[i],texts,i),calculate_sentence_freq(texts[i],vocab)])
...
#             max_index =i
#     print(page[max_index].value,page[max_index].line)
#
# index =0
# if_first =True
# while True:
